    ...
    <div class="container">
        <div class="row">
            {{-- <div class="col-md-8">
                    ...
                    <div class="post-item-body">
                        ...
                        <div class="post-meta padding-10 clearfix">
                            ...
                            <div class="pull-right">
                                <a href="post.html">Lire plus &raquo;</a>
                            </div>
                        </div>
                    </div>
                </article>
                ...
                <nav>
                  <ul class="pager">
                    <li class="previous disabled"><a href="#"><span aria-hidden="true">&larr;</span> Suivant</a></li>
                    <li class="next"><a href="#">précedent <span aria-hidden="true">&rarr;</span></a></li>
                  </ul>
                </nav>
            </div> --}}
            <div class="col-md-8">
                ...
                <nav>
                  <ul class="pager">
                    <li class="previous disabled"><a href="#"><span aria-hidden="true">←</span> Suivant</a></li>
